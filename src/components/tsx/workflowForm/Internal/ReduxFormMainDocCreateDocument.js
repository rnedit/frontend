...
import { setUpdateRecipient } from "../../../../reducers/createInternal"

import { useGetProfilesByParentIdNotNullQuery } from "../../generated/graphql"
        ...
        <Grid item xs={12} md={6}>
          <Typography component="div" style={{
            ...
            <Box display="flex" justifyContent="right">
              <DialogListAddProfile type="CreateInternal" multiple={false} data={profiles} callBackInternal={callBackInternal} />
            </Box>
...
InitializeFromStateForm = connect(
  state => ({
    initialValues: state.createInternal, // pull initial values from reducer
